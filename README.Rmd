...
If you just want to use the cofad-app, you do not need to install it. Just go to cofad.titz.science and use it there. An example data file is loaded when you go to cofad.titz.science/example.
