...
```{r}
ca <- calc_contrast(variable = empathy, between = major,
              between_levels = c("psychology", "education", "business", "chemistry"),
              lambda_between = c(1, -1, 0, 0), data = d)
ca
```
...
ca <- calc_contrast(variable = empathy, between = major,
              between_levels = c("psychology", "education", "business", "chemistry"),
              lambda_between = c(0, 0, 1, -1), data = d)
ca
ca <- calc_contrast(variable = empathy, between = major,
              between_levels = c("psychology", "education", "business", "chemistry"),
              lambda_between = c(1, 1, -1, -1), data = d)
ca
```
...
ca <- calc_contrast(variable = empathy, between = major,
              between_levels = c("psychology", "education", "business", "chemistry"),
              lambda_between = c(73, 61, 51, 38), data = d)
ca
```
...
head(d)
calc_contrast(variable = reading_test, within = music,
              within_levels = c("without music", "white noise", "classic", "jazz"),
              lambda_within = c(1.25, 0.25, -0.75, -0.75), ID = participant, data = d)
```
