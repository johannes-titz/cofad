...
The idea of mixed designs is a combination of between and within factors. So contrast analysis calculates at first the *L-Value* for the within factor and treated this composite score as new dependent variable. @Rosenthal2000 gives an illustrative example in table 5.3.. Nine children are measured four times (within) and belong to diffrent groups of age (between). 
...
contr_mx
```
The results look like a contrast analysis for between-subject Designs, the second step of the mixed desing contrastanalysis. The summary give you some more details: The Effectsizes and **$within Groups** for means and standard errors of the L-Values. 
```{r}
summary(contr_mx)
```
