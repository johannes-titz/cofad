...
With `cofad` you can also compare two competing hypothesis. As an example @sedlmeier2013 use a fictious data set on problem solving skills of boys:
...
Note that we use lambda2 as the first entry into `lambda_diff` because this is how @sedlmeier2013 calculcated it (hypothesis2-hypothesis1).
